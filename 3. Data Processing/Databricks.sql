...
---adding time buckets
CASE 
    WHEN Record_time BETWEEN '05:00:00' AND '11:59:59' THEN '5am to 11am views'
    WHEN Record_time BETWEEN '12:00:00' AND '17:59:59' THEN '12pm to 5pm views'
    WHEN Record_time BETWEEN '18:00:00' AND '20:59:59' THEN '6pm to 8pm views'
    WHEN Record_time BETWEEN '21:00:00' AND '23:59:59' THEN '9pm to 11pm views'
    ELSE '12am to 4am views'
END AS `Time Slots`,
---classifying our days
CASE
   WHEN Dayname IN('Mon','Tue','Wed','Thu','Fri') THEN 'Weekday'
   ELSE 'Weekend'
END AS `Day Classification`,
